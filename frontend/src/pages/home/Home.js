            ...
            <>
                ...
                <div className="container" style={{position:'relative'}} >
                    <div className="card-top-n teste" >
                        ...
                        {this.state.user?.data.name} Gomes Nascimento
                        {  this.state.home ? <h3>Meus Cards</h3> : null}
                        {  this.state.hospital ? <h3>Hospitalar</h3>: null}
                        {  this.state.animal ?  <h3>Animais</h3>: null}
                        {  this.state.criancaPCD ? <h3>Crianças e PCD</h3>: null}
                        <button className="close" ><MdSettings/></button>
                ...
                <p style={{textAlign: 'center'}}> QR Id © 2020. Todos os direitos reservados</p>
            </>
        );
    }
}
